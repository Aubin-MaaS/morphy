...
echo -e "   git checkout master && git merge $(git branch --show-current) && git tag v$(grep '^version:' zikzak_morphy/pubspec.yaml | sed 's/version: //') && git push origin master --tags"
echo -e ""
